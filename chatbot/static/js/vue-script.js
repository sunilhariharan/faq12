window.addEventListener('load', function () {
    var vm = new Vue({
        ...
        data: {
            ...
            json: null,
            custom: false,
            changeLevel: ['Choose a different application', 'Choose a different module','Choose a different issue'],
            questionHeader: ['Does your query pertain to any of the following applications?', 'Choose a module', 'Choose a issue']
        },
        methods: {
